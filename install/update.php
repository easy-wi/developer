...
if (versioncheck($version, '6.2.3', 'update_622-623.php', $response)) {
    $version = '6.2.3';
}
if (versioncheck($version, '6.2.4', 'update_623-624.php', $response)) {
    $version = '6.2.4';
}
if (versioncheck($version, '6.2.5', 'update_624-625.php', $response)) {
    $version = '6.2.5';
}
