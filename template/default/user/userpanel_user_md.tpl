            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php } else { ?>
                        <a class="btn btn-block btn-social btn-<?php echo str_replace('twitchtv', 'twitch', strtolower($sp['sp']));?> span10" href="userpanel.php?w=se&amp;spUser=<?php echo $sp['spUserId'];?>&amp;spId=<?php echo $sp['spId'];?>&amp;r=se" id="sp<?php echo $sp['sp'];?>">
