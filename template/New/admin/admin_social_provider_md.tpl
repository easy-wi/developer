            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group<?php if(isset($errors['name'])) echo ' has-error';?>">
                        <label for="inputName">Social Auth Provider</label>
                        <div class="controls">
                    ...
                    <div class="form-group<?php if(isset($errors['keyID'])) echo ' has-error';?>">
                        <label for="inputKeyID">ID/Key</label>
                        <div class="controls">
                            <input class="form-control" id="inputKeyID" type="text" name="keyID" value="<?php echo $keyID;?>">
                        </div>
                    </div>

                    <div class="form-group<?php if(isset($errors['providerToken'])) echo ' has-error';?>">
