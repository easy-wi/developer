                    ...
                    <div class="box-header">
                        ...
                        <ul class="list-group list-group-flush">
                             <li class="list-group-item">
                                ...
                                <label class="form-check-label" for="inputServerID-<?php echo $id;?>"><?php echo $server['ip'].' '.$server['description'];?> </label>
                            </li>
                        </ul>
                        <?php } ?>
                    </div>
                    ...
                    <div class="box-header">
                        ...
                        <div class="checkbox" id="masterID-<?php echo $id;?>" data-server="<?php echo $master['serverIDs'];?>">
                             <li class="list-group-item">
                                ...
                                <label class="form-check-label" for="inputMasterID-<?php echo $id;?>">
