                ...
                <form role="form" action="admin.php?w=ro&amp;d=md&amp;id=<?php echo $id;?>&amp;r=ro" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls"><input class="form-control" id="inputSteamCmd" type="password" name="steamAccount" value="<?php echo $steamAccount;?>"></div>
                        </div>

                        <div class="form-group">
                            <label for="inputSteamCmdPWD">SteamCmd <?php echo $sprache->password;?></label>
                            <div class="controls"><input class="form-control" id="inputSteamCmdPWD" type="password" name="steamPassword" value="<?php echo $steamPassword;?>"></div>
                        </div>
                    </div>
