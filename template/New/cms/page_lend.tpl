...
<form id=gs class="form-horizontal" action="<?php echo $page_data->pages['lendservergs']['link'];?>" method="post">
    ...
    <p><b><?php echo $key.': '.$sprache->available.' '.$value['amount'].'/'.$value['total'];?></b></p>
    <?php } ?>
    <?php if ($serveravailable==true) { ?></div>
    ...
    <form id=gs class="form-horizontal" action="<?php echo $page_data->pages['lendservervoice']['link'];?>" method="post">
