...
<div class="container">
  <div class="row">
    ...
    <?php if(count($error)>0){ ?><div class="span11 alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button><i class="icon-warning-sign"></i> <?php echo implode('<br />',$error);?></div><?php }?>
        ...
        <form class="form" action="<?php echo $page_data->pages['register']['link'];?>" method="post">
            ...
            <div class="control-group <?php if(isset($alert['password'])) echo 'error';?>">
                ...
                <div class="controls">
                    <input type="password" id="inputPassword" name="password" value="<?php echo $password;?>" required>
                </div>
            </div>
            <div class="control-group <?php if(isset($alert['password2'])) echo 'error';?>">
                ...
                <div class="controls">
                    <input type="password" id="inputPasswordSecond" name="passwordsecond" value="<?php echo $passwordsecond;?>" required>
                </div>
            </div>
