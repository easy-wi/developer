                ...
                <form role="form" action="userpanel.php?w=gs&amp;d=md&amp;id=<?php echo $id;?>&amp;r=gs" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly class="form-control" id="ftppass" type="text" name="ftppass" value="<?php echo $ftppass;?>" required>
                        </div>
                        <?php } ?>
                        ...
                        <div class="<?php echo $table_row['id'].' '.$table_row['displayNone'];?> switch">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="steamServerToken_<?php echo $table_row['id'];?>" type="password" name="steamServerToken_<?php echo $table_row['id'];?>" value="<?php echo $table_row['steamServerToken'];?>">
                            </div>
                            <?php } ?>
                            ...
                            <div class="Y <?php if($table_row['workShop']=='N') echo 'display_none';?> mapGroupWorkShop-<?php echo $table_row['id'];?> form-group">
                                ...
                                <input class="form-control" id="webapiAuthkey_<?php echo $table_row['id'];?>" type="password" name="webapiAuthkey_<?php echo $table_row['id'];?>" value="<?php echo $table_row['webapiAuthkey'];?>">
