...
if ($currentStep == 0) {
    ...
    if (!$json or !property_exists($json, 'v') or '5.21' == $json->v) {
...
";
        ...
        try {
            ...
            $query = $sql->prepare("INSERT INTO `easywi_version` (`id`,`version`,`de`,`en`) VALUES (1,'5.21','','') ON DUPLICATE KEY UPDATE `id`=`id`");
            $query->execute();
