                ...
                <form role="form" action="admin.php?w=bu&amp;d=bu" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post">
                    ...
                    <div class="form-group">
                        <label for="inputUpdate"><?php echo $gsprache->backup;?></label>
                            <button class="btn btn-primary btn-sm" id="inputUpdate" type="submit"><i class="fa fa-download"></i></button>
                    </div>
                </form>
                ...
                <form role="form" action="admin.php?w=bu&amp;d=rp&amp;r=bu" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post">
                    ...
                    <div class="form-group">
                        <label  for="inputUpdate"><?php echo $gsprache->database.' '.$gsprache->repair;?></label>
                            <button class="btn btn-primary btn-sm" id="inputUpdate" type="submit"><i class="fa fa-refresh"></i></button>
                </form>
                    </div>
            <?php } ?>
                    <div class="form-group">
                        <label for="inputGS"><?php echo $gsprache->gameserver.' '.$gsprache->template;?></label>
                            <a href="admin.php?w=bu&amp;d=rg" id="inputGS"><button class="btn btn-primary btn-sm" id="inputGS" type="submit"><i class="fa fa-refresh"></i></button></a>
                    </div>
                    <div class="form-group">
                        <label for="inputAO"><?php echo $gsprache->gameserver.' '.$gsprache->addon;?></label>
                            <a href="admin.php?w=bu&amp;d=ra" id="inputGS"><button class="btn btn-primary btn-sm" id="inputAO" type="submit"><i class="fa fa-refresh"></i></button></a>
                    </div>
        </div>
    </div>
</section>