...
<div class="box box-info">
    ...
    <form role="form" action="userpanel.php?w=fd&amp;d=es&amp;id=<?php echo $id;?>&amp;r=fd" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post">
        ...
        <div class="form-group <?php if ($masterfdl=='Y') echo 'display_none'; ?> switch control-group<?php if(isset($errors['ftp_adresse'])) echo ' error';?>">
        ...
        <div class="form-group <?php if ($masterfdl=='Y') echo 'display_none'; ?> switch control-group<?php if(isset($errors['ftp_port'])) echo ' error';?>">
        ...
        <div class="form-group <?php if ($masterfdl=='Y') echo 'display_none'; ?> switch control-group<?php if(isset($errors['ftp_user'])) echo ' error';?>">
        ...
        <div class="form-group <?php if ($masterfdl=='Y') echo 'display_none'; ?> switch control-group<?php if(isset($errors['ftp_password'])) echo ' error';?>">
        ...
        <div class="form-group <?php if ($masterfdl=='Y') echo 'display_none'; ?> switch control-group">
