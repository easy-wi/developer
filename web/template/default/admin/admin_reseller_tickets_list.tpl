<section class="content-header">
    <h1><?php echo $gsprache->support . ' ' . $gsprache->support;?></h1>
    <ol class="breadcrumb">
        <li><a href="admin.php"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="admin.php?w=tr"><i class="fa fa-life-ring"></i> <?php echo $gsprache->support . ' ' . $gsprache->support;?></a></li>
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="admin.php?w=tr&amp;d=md&amp;id=<?php echo $table_row['id'];?>"><span class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo $gsprache->mod;?></span></a></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                            <tfoot>
