<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
            ...
            <li><?php echo $gsprache->userImport;?> <span class="divider">/</span></li>
...
<div class="row-fluid">
    <div class="span6">
        <?php echo $gsprache->userImport;?> <a href="admin.php?w=ui&amp;d=ad"><span class="btn btn-primary btn-mini"><i class="icon-white icon-plus-sign"></i></span></a>
    </div>
</div>
<hr>
<div class="row-fluid">
    <div class="span11 pagination">
        <ul>
            <li><a href="admin.php?w=ui&amp;o=<?php echo $o;?>&amp;a=<?php if(!isset($amount)) echo "20"; else echo $amount; ?>&p=<?php echo $zur;?>"><i class="icon-step-backward"></i></a></li>
            ...
            <li><a href="admin.php?w=ui&amp;o=<?php echo $o;?>&amp;a=<?php if(!isset($amount)) echo "20"; else echo $amount; ?>&p=<?php echo $vor;?>"><i class="icon-step-forward"></i></a></li>
        </ul>
    </div>
</div>
<div class="row-fluid">
