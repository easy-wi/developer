<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo $newsTitle;?></li>
    </ol>
</section>
...
<section class="content">
    ...
    <form role="form" action="admin.php?w=pn&amp;d=md&amp;id=<?php echo $id;?>&amp;r=pn" onsubmit="submitToForm(); return confirm('<?php echo $gsprache->sure;?>');" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                <label class="checkbox-inline">
                                    <input name="language[]" value="<?php echo $lg;?>" onclick="textdrop('<?php echo $lg;?>');" type="checkbox" <?php if($table[$lg]['text']!=false) echo 'checked';?>> <img src="images/flags/<?php echo $lg;?>.png" alt="Flag: 16_<?php echo $lg;?>.png" >
                                </label>
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" style="height:200px;overflow:auto;">
                            <table id="categories_list_<?php echo $lg;?>" class="table table-bordered table-hover table-striped">
                                <?php foreach($table[$lg]['categories'] as $category){ ?>
                                <tr>
                                    <td><input type="checkbox" name="categories[<?php echo $lg;?>][]" value="<?php echo $category;?>" checked="checked"> <?php echo $category;?></td>
                                </tr>
                                <?php }?>
