    ...
    <div class="span11">
        <table class="table table-condensed table-bordered table-hover footable">
            ...
            <tr>
                ...
                <th data-hide="phone,tablet"><a href="<?php echo $ticketLinks['all'];?>&amp;o=<?php if ($o=='ai') { echo 'di'; } else { echo 'ai'; } ?>">ID</a></th>
                ...
                <th data-hide="phone,tablet"><a href="<?php echo $ticketLinks['all'];?>&amp;o=<?php if ($o=='ap') { echo 'dp'; } else { echo 'ap'; } ?>"><?php echo $gsprache->user.' '.$sprache->priority;?></a></th>
                <th data-hide="phone,tablet"><a href="<?php echo $ticketLinks['all'];?>&amp;o=<?php if ($o=='ae') { echo 'de'; } else { echo 'ae'; } ?>"><?php echo $sprache->edit2;?></a></th>
                <th data-hide="phone"><a href="<?php echo $ticketLinks['all'];?>&amp;o=<?php if ($o=='au') { echo 'du'; } else { echo 'au'; } ?>"><?php echo $sprache->username;?></a></th>
                <th data-hide="phone,tablet"><a href="<?php echo $ticketLinks['all'];?>&amp;o=<?php if ($o=='ad') { echo 'dd'; } else { echo 'ad'; } ?>"><?php echo $sprache->date;?></a></th>
            ...
            <tr class="<?php echo $table_row['statusClass'];?>">
                ...
                <td><?php echo $table_row['user'];?></td>
                <td><?php echo $table_row['writedate'];?></td>
                <td><a href="admin.php?w=ti&amp;d=md&amp;id=<?php echo $table_row['id'];?>" alt="modify"><span class="btn btn-primary btn-mini"><i class="icon-edit icon-white"></i></span></a></td>
            </tr>
            <?php } ?>
            </tbody>
        </table>
