    ...
    <div class="span11">
        <table class="table table-bordered table-hover table-striped footable">
            ...
            <tr>
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered table-hover table-condensed">
                                ...
                                <tr class="<?php if($row['status']==1) echo 'success'; else if($row['status']==2) echo 'warning'; else echo 'error';?>">
                                    ...
                                    <td><a href="admin.php?w=vr&amp;d=dl&amp;id=<?php echo $row['id'];?>" ><span class="btn btn-mini btn-primary"><i class="icon-white icon-remove-sign"></i></span></a></td>
                ...
                <td><a href="admin.php?w=vd&amp;d=dl&amp;id=<?php echo $table_row['id'];?>" ><span class="btn btn-mini btn-primary"><i class="icon-white icon-remove-sign"></i></span></a></td>
