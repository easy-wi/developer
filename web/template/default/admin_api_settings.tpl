        ...
        <form class="form-horizontal" action="admin.php?w=ap&amp;r=ap" onsubmit="return confirm('<?php echo $gsprache->sure; ?>');" method="post">
            ...
            <div id="ips">
                ...
                <div id="<?php echo $ip?>" class="control-group">
                    ...
                    <div class="controls">
                        <input id="inputIPs-<?php echo $ip?>" type="text" name="ip[]" value="<?php echo $ip?>" maxlength="15" required> <span class="btn btn-mini btn-primary" onclick="Remove('<?php echo $ip?>')"><i class="icon-white icon-remove-sign"></i></span>
                    </div>
                </div>
                <?php } ?>
            </div>
