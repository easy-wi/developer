<div class="row-fluid">
    <div class="span12">
        <ul class="breadcrumb">
            ...
            <li><a href="userpanel.php?w=de"><?php echo $gsprache->dedicated;?></a> <span class="divider">/</span></li>
...
<div class="row-fluid">
    <div class="span6">
        <form class="form-horizontal" action="userpanel.php?w=de&amp;d=ri&amp;id=<?php echo $id;?>&amp;r=de" onsubmit="return confirm('<?php echo $gsprache->sure; ?>');" method="post">
