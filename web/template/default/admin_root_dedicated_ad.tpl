...
<div class="row-fluid">
    <div class="span11">
        <form class="form-horizontal" action="admin.php?w=rh&amp;d=ad&amp;r=rh" onsubmit="return confirm('<?php echo $gsprache->sure; ?>');" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="inputReseller" class="span11" name="userID">
                        <option value="N"><?php echo $gsprache->no;?></option>
                        <?php foreach ($table as $key=>$val){ ?><option value="<?php echo $key;?>"><?php echo $val;?></option><?php } ?>
                    </select>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputExternalID">externalID</label>
                <div class="controls"><input id="inputExternalID" type="text" class="span11" name="externalID" value="" maxlength="255"></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputMac"><?php echo $sprache->mac;?></label>
                <div class="controls"><input id="inputMac" type="text" class="span11" name="mac" maxlength="17" value=""></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputIp"><?php echo $sprache->ip;?></label>
                <div class="controls"><input id="inputIp" type="text" class="span11" name="ip" maxlength="15" value=""></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputIps"><?php echo $sprache->ips;?></label>
                <div class="controls"><textarea id="inputIps" class="span11" name="ips" rows="5"></textarea></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inputDesc"><?php echo $sprache->description;?></label>
                <div class="controls"><textarea id="inputDesc" class="span11" name="description" rows="5"></textarea></div>
            </div>
            <div class="control-group">
            ...
            <div class="A switch control-group">
            ...
            <div class="A switch control-group">
                ...
                <div class="controls"><input id="inputRESTAPIURL" type="text" class="span11" name="apiURL" value=""></div>
            </div>
            <div class="A switch control-group">
            ...
            <div class="A switch control-group">
                ...
                <div class="controls"><textarea id="inputAPIRequestRestart" class="span11" name="apiRequestRestart" rows="5"></textarea></div>
            </div>
            <div class="A switch control-group">
                <label class="control-label" for="inputAPIRequestStop">API Request Stop</label>
                <div class="controls"><textarea id="inputAPIRequestStop" class="span11" name="apiRequestStop" rows="5"></textarea></div>
            </div>
