...
<div class="row-fluid">
    <div class="span6">
        <form class="form-horizontal" action="admin.php?w=vs&amp;d=va&amp;id=<?php echo $id;?>&amp;r=vs" onsubmit="return confirm('<?php echo $gsprache->sure; ?>');" method="post">
            ...
            <div class="ri display_none switch control-group">
                ...
                <div class="controls">
                    <select id="inputImage" name="imageid">
                        <?php foreach ($templates as $template){ ?><option value="<?php echo $template['id']?>"><?php echo $template['description'];?></option><?php } ?>
                    </select>
                </div>
            </div>
            <div class="control-group">
