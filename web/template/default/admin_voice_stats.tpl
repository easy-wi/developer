    ...
    <div class="span11">
        <form class="form-horizontal" action="admin.php?w=vu" onsubmit="return confirm('<?php echo $gsprache->sure; ?>');" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="inputStats" name="kind" onchange="getdetails('serverallocation.php?d=vu&amp;w=',this.value)">
            ...
            <div class="control-group">
                ...
                <div class="controls"><button class="btn btn-primary pull-right" id="inputEdit" type="submit"><i class="icon-edit icon-white"></i></button></div>
            </div>
        </form>
    </div>
</div>
