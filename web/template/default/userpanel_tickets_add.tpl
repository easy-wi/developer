    ...
    <div class="span11">
        <form class="form-horizontal" action="userpanel.php?w=ti&amp;d=ad&amp;r=ti" onsubmit="return confirm('<?php echo $gsprache->sure;?>');" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="priority" name="userPriority" class="span10">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="topic_name" name="maintopic" onchange="getdetails('serverallocation.php?d=rt&amp;po=', this.value)" class="span10">
