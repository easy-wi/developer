...
class HttpdManagement {
    ...
    private function getVhostData ($vhostID) {
        ...
        if ($this->vhostData == false) {
            ...
            foreach ($query->fetchAll(PDO::FETCH_ASSOC) as $row) {
                ...
                $this->vhostData['templateFileContent'] = '# DO NOT EDIT DIRECTLY! This file is autogenerated by easy-wi.com. Date of generation was ' . date('Y-m-d') . "\r\n";
    ...
    private function changePassword ($vhostID, $newPassword = false) {
