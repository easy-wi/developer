...
$gameImages = array(
    ...
    array(
        ...
        ':modcmds' => "[Vanilla = default]\r\n\r\n[SotF]\r\n-TotalConversionMod=496735411",
        ':tic' => null,
        ':gameq' => 'source',
        ':gamemod' => 'N',
        ':gamemod2' => null,
    ...
    array(
        ...
        ':slots' => 20,
        ':map' => '',
        ':cmd' => './%binary% -ip=%ip% -port=%port% -profiles=cfg -config=cfg/server.cfg -cfg=cfg/basic.cfg -name=default -maxmem=%maxram%',
        ':modcmds' => null,
        ':tic' => null,
        ':gameq' => 'armedassault3',
        ':gamemod' => 'N',
    ...
    array(
        ...
        ':slots' => 20,
        ':map' => '',
        ':cmd' => './%binary% -batchmode +server.ip %ip% +rcon.ip %ip% +server.port %port% +server.maxplayers %slots% +server.identity "cfg" +rcon.port %port2% -server.worldsize 4000 -logFile "server.txt"',
        ':modcmds' => null,
        ':tic' => null,
        ':gameq' => 'source',
        ':gamemod' => 'N',
